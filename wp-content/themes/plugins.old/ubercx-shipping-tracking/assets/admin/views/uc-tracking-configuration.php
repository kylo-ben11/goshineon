...
if(!isset($uc_options['tracking_domain_url']) || $uc_options['tracking_domain_url'] == ''){
  $uc_options['tracking_domain_url'] = 'snapcx.io';
}
...
<div class="wrap">
	<div id="fsb-wrap" class="fsb-help">
		...
		<form method="post" action="options.php">
			...
			<p>http://track.<input size="36" id="uc_settings[tracking_domain_url]" name="uc_settings[tracking_domain_url]" type="text" value="<?php echo $uc_options['tracking_domain_url']; ?>" required/>/
			</p>
