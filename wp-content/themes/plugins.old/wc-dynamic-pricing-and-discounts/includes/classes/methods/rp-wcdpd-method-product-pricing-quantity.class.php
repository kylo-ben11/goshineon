...
abstract class RP_WCDPD_Method_Product_Pricing_Quantity extends RP_WCDPD_Method_Product_Pricing
{
    ...
    public function get_adjustments($rule, $cart_items = null)
    {
        ...
        foreach ($cart_items as $cart_item_key => $cart_item) {
            ...
            if (!RP_WCDPD_Controller_Methods_Product_Pricing::is_already_processed($rule['uid'], $cart_item_key) && isset($cart_items_to_adjust[$cart_item_key])) {
                ...
                $adjustments[$cart_item_key] = array(
                    ...
                    'reference_amount'  => $this->get_reference_amount(array('rule' => $rule, 'receive_quantity' => $cart_items_to_adjust[$cart_item_key]), $base_price, $cart_item),
                );
            }
        }
