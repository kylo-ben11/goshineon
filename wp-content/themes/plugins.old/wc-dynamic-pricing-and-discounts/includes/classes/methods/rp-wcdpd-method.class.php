...
abstract class RP_WCDPD_Method extends RP_WCDPD_Item
{
    ...
    public function custom_item_properties()
    {
        return array(
            ...
            'apply_adjustment_to_prices_callback'   => array($this, 'apply_adjustment_to_prices'),
        );
    }
    ...
    public function get_adjustments($rule, $cart_items = null)
    {
        ...
        if (RP_WCDPD_Conditions::rule_conditions_are_matched($rule, array('context' => $this->context))) {
