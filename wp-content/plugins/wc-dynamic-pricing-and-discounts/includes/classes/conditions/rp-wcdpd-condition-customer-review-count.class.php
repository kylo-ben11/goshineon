...
if (!class_exists('RP_WCDPD_Condition_Customer')) {
    include_once('rp-wcdpd-condition-customer.class.php');
}

/**
 * Condition: Customer - Review Count
 *
 * @class RP_WCDPD_Condition_Customer_Review_Count
 * @package WooCommerce Dynamic Pricing & Discounts
 * @author RightPress
 */
if (!class_exists('RP_WCDPD_Condition_Customer_Review_Count')) {

class RP_WCDPD_Condition_Customer_Review_Count extends RP_WCDPD_Condition_Customer
{
...
RP_WCDPD_Condition_Customer_Review_Count::get_instance();
