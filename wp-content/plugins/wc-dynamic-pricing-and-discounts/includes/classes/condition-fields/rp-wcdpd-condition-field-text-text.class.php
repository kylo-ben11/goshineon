...
if (!class_exists('RP_WCDPD_Condition_Field_Text')) {
    include_once('rp-wcdpd-condition-field-text.class.php');
}
...
class RP_WCDPD_Condition_Field_Text_Text extends RP_WCDPD_Condition_Field_Text
{
    ...
    public function validate($posted, $condition, $method_option_key)
    {
        ...
        if (in_array($condition['method'], array('meta'), true) && in_array($method_option_key, array('is_empty', 'is_not_empty', 'is_checked', 'is_not_checked'), true)) {
            return true;
        }
