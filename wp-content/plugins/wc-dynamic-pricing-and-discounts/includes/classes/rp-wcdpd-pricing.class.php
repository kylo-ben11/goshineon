...
class RP_WCDPD_Pricing
{
     ...
     * @return float
     */
    public static function get_adjustment_value($combined_key, $setting, $reference_amount = 0, $adjustment = null)
    {
        // Load pricing method
        if ($pricing_method = RP_WCDPD_Controller_Pricing_Methods::get_item($combined_key)) {
            return call_user_func($pricing_method['calculate_callback'], $setting, $reference_amount, $adjustment);
        }
